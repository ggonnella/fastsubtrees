...
class TestClass:
    ...
    #     tree = Tree.from_file('./tests/small_tree.tree')
    #     elemparentid = element_parent_ids('./tests/testdata/smalltree_add_subtree.tsv')
    ...
    #     create_tree.to_file(outfname)
    #     tree = Tree.from_file('./tests/middle_tree.tree')
    #     elemparentid = element_parent_ids('./tests/testdata/middletree_add_subtree.tsv')
    #     generator = elemparentid.get_element_parent_id()
    #     tree.add_subtree(generator)
    ...
    #     elemparentid = element_parent_ids('./tests/testdata/add_subtree_repeated_nodes.tsv')
    #     generator = elemparentid.get_element_parent_id()
    #     with pytest.raises(error.ConstructionError):
    #         tree.add_subtree(generator)
    ...
    #     create_tree.to_file(outfname)
    #     tree = Tree.from_file('./tests/small_tree_repeated_node_id.tree')
    #     elemparentid = element_parent_ids('./tests/testdata/add_subtree_parent_not_exist.tsv')
    #     generator = elemparentid.get_element_parent_id()
    #     with pytest.raises(error.ConstructionError):
    #         tree.add_subtree(generator)
    #         os.remove('./tests/small_tree_repeated_node_id.tree')
    ...
    #     create_tree.to_file(outfname)
    #     tree = Tree.from_file('./tests/small_tree_repeated_node_id.tree')
    #     elemparentid = element_parent_ids('./tests/testdata/construction_node0.tsv')
    #     generator = elemparentid.get_element_parent_id()
    #     with pytest.raises(error.ConstructionError):
    #         tree.add_subtree(generator)
    #         os.remove('./tests/small_tree_repeated_node_id.tree')
    ...
    #     elemparentid = element_parent_ids('./tests/testdata/add_already_deleted_node.tsv')
    #     generator = elemparentid.get_element_parent_id()
